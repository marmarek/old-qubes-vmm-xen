...
./configure --prefix=%{_prefix} --libdir=%{_libdir} --with-system-seabios=/usr/share/seabios/bios.bin --enable-vtpm-stubdom --enable-vtpmmgr-stubdom
...
%if !%build_ocaml
rm -f %{buildroot}%{_unitdir}/oxenstored.service
%endif
# stubdom: newlib
